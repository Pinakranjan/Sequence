...
{{-- Reusable Customer Add/Edit/View Modal --}}
<div class="modal fade" id="{{ $buildId('customerModal') }}" tabindex="-1"
    aria-labelledby="{{ $buildId('customerModalLabel') }}" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" style="max-width:760px;">
        <div class="modal-content">
            <div class="modal-header py-2" style="min-height:42px;">
                <h5 class="modal-title d-flex align-items-center fs-6" id="{{ $buildId('customerModalLabel') }}">
                    <i class="fa-solid fa-people-group me-2" style="width:18px;height:18px;line-height:18px;"></i>
                    <span id="{{ $buildId('modalTitle') }}">Add Customer</span>
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form id="{{ $buildId('customerForm') }}" method="POST" action="{{ url('/customer/create') }}"
                ...
                <input type="hidden" id="{{ $buildId('customer_id') }}" name="id" />
                <div class="modal-body">
                    <div class="col-12">
                        <div class="row g-2 align-items-start">
                            <div class="col-12 col-md-8 pe-md-2">
                                <label for="{{ $buildId('customer_name') }}" class="form-label">Customer Name <span
                                        class="text-danger">*</span></label>
                                <input type="text" id="{{ $buildId('customer_name') }}" name="customer_name"
                                    class="form-control" maxlength="100" autocomplete="off" required />
                                <div class="invalid-feedback" id="{{ $buildId('customer_name_error') }}">Customer name
                                    is required.</div>
                            </div>
                            <div class="col-12 col-md-4 ps-md-2">
                                <label for="{{ $buildId('customer_code') }}" class="form-label">Customer Code <span
                                        class="text-danger">*</span></label>
                                <input type="text" id="{{ $buildId('customer_code') }}" name="customer_code"
                                ...
                                <div class="invalid-feedback" id="{{ $buildId('customer_code_error') }}">Customer code
                                    is required.</div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row gx-4 gy-2 gx-2">
                            ...
                            <div class="col-12 col-md-6 ps-md-2">
                                ...
                                <input type="text" class="form-control text-center" id="{{ $buildId('mobile_no') }}"
                                    ...
                                    autocomplete="off" required title="Enter 10 digit mobile number">
                    ...
                    <div class="col-12 mt-2">
                        <div class="row gx-4 gy-2 gx-2">
                            ...
                            <div class="col-12 col-md-6 ps-md-2">
                                ...
                                <div class="invalid-feedback" id="{{ $buildId('pan_error') }}">Enter a valid PAN (e.g.,
                                    AAAAA0000A).</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-100 d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <button type="button" class="btn btn-outline-danger" data-bs-dismiss="modal">
                                <i data-feather="x" class="me-1"></i><span>Cancel</span>
                            </button>
                            <button type="submit" class="btn btn-primary" id="{{ $buildId('submitBtn') }}">
                                <i data-feather="save" class="me-1"></i><span>Save</span>
                            </button>
                        </div>
                    </div>
                </div>

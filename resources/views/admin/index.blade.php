...
@section('admin')
    ...
    <div class="content">
        <!-- Start Content-->
        <div class="container-xxl with-gutters">
                ...
                <div class="col-md-6 col-xl-8">
                    <div class="card">
                        ...
                        <div class="card-header py-2">
                            <div class="d-flex align-items-center">
                                <div class="border border-white rounded-2 me-2 widget-icons-sections">
                            ...
                            <div class="table-responsive">
                                <table class="table table-traffic mb-0">
                                    <tbody>
                                        ...
                                        {{-- Hidden placeholder: required by analytics-dashboard.init.js
                                        (sparkline-bounce-2) --}}
                                        <tr class="d-none">
                                            <td colspan="5">

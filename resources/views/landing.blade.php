...
@section('main_content')
            ...
            <a href="{{ route('home') }}" class="landing-nav__brand">
                <div class="landing-nav__logo-icon">
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M19 17H22M19 17V11H22M19 17L13 21L7 17M7 17H4M7 17V11H4M7 11L13 7L19 11M13 7V3M13 7L7 11" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </div>
            ...
            <div class="landing-hero__cta" data-aos="fade-up" data-aos-delay="300">
                <a href="{{ route('register') }}" class="landing-btn landing-btn--primary landing-btn--lg">
                    ...
                    <svg width="18" height="18" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M4.167 10H15.833M15.833 10L10 4.167M15.833 10L10 15.833" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </a>
        ...
        <div class="landing-hero__stats" data-aos="fade-up" data-aos-delay="400">
            <div class="landing-stat-card">
                <div class="landing-stat-card__icon landing-stat-card__icon--blue">
                    <svg viewBox="0 0 24 24" fill="none"><path d="M9 17a2 2 0 1 1-4 0 2 2 0 0 1 4 0ZM19 17a2 2 0 1 1-4 0 2 2 0 0 1 4 0Z" stroke="currentColor" stroke-width="2"/><path d="M13 16V6h5l3 5v5h-1M13 16H9M5 11H1M3 9v4" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                </div>
            ...
            <div class="landing-stat-card">
                <div class="landing-stat-card__icon landing-stat-card__icon--orange">
                    <svg viewBox="0 0 24 24" fill="none"><path d="M12 22s-8-4.5-8-11.8A8 8 0 0 1 12 2a8 8 0 0 1 8 8.2c0 7.3-8 11.8-8 11.8Z" stroke="currentColor" stroke-width="2"/><circle cx="12" cy="10" r="3" stroke="currentColor" stroke-width="2"/></svg>
                </div>
                <div class="landing-stat-card__text">
    ...
    <section class="landing-features">
        <div class="landing-features__inner">
            <h2 class="landing-section-title" data-aos="fade-up">Why Choose <span class="landing-hero__highlight">Sequence</span>?</h2>
            ...
            <div class="landing-features__grid">
                ...
                <div class="landing-feature-card" data-aos="fade-up" data-aos-delay="400">
                    <div class="landing-feature-card__icon">
                        <svg viewBox="0 0 24 24" fill="none"><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10Z" stroke="currentColor" stroke-width="2"/><path d="m9 12 2 2 4-4" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                    </div>
...
<style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .landing-nav__logo-icon svg { width: 100%; height: 100%; }
    .landing-nav__brand-text {
        font-size: 1.25rem; font-weight: 800; color: #0f172a;
        letter-spacing: -0.02em;
    }
    .landing-nav__actions { display: flex; gap: 12px; align-items: center; }
    ...
    .landing-btn--primary {
        ...
        color: #fff; box-shadow: 0 4px 15px rgba(249,115,22,0.25);
    }
    ...
    .landing-btn--outline:hover {
        background: rgba(0,0,0,0.03); color: #1e293b;
    ...
    .landing-btn--lg { padding: 14px 32px; font-size: 1rem; border-radius: 12px; }
    ...
    .landing-hero__content { position: relative; z-index: 1; max-width: 800px; }
    ...
    .landing-hero__cta { display: flex; gap: 16px; justify-content: center; flex-wrap: wrap; }
    ...
    .landing-stat-card__icon svg { width: 22px; height: 22px; }
    .landing-stat-card__icon--blue { background: rgba(59,130,246,0.1); color: #3b82f6; }
    .landing-stat-card__icon--green { background: rgba(34,197,94,0.1); color: #22c55e; }
    .landing-stat-card__icon--orange { background: rgba(249,115,22,0.1); color: #f97316; }
    .landing-stat-card__text { display: flex; flex-direction: column; }
    .landing-stat-card__number { font-size: 1.4rem; font-weight: 800; color: #0f172a; }
    .landing-stat-card__label { font-size: 0.78rem; color: #64748b; font-weight: 500; }
    ...
    .landing-features__inner { max-width: 1100px; margin: 0 auto; text-align: center; }
    ...
    .landing-feature-card__icon svg { width: 24px; height: 24px; color: #f97316; }
    .landing-feature-card h3 {
        font-size: 1.15rem; font-weight: 700; color: #0f172a;
        margin-bottom: 10px;
    }
    .landing-feature-card p { font-size: 0.9rem; color: #64748b; line-height: 1.7; }

    /* ─── Responsive ─── */
    @media (max-width: 640px) {
        .landing-nav { padding: 12px 16px; }
        .landing-btn--lg { padding: 12px 24px; font-size: 0.9rem; }
        .landing-hero { padding: 100px 16px 40px; }
        .landing-hero__stats { flex-direction: column; align-items: center; }
        .landing-stat-card { width: 100%; max-width: 300px; }

    ...
    <div class="footer position-relative">
        <div class="mybazar-login-section ">
            <div class="mybazar-login-wrapper ">
                <div class="login-wrapper">
                    <div class="login-body w-100">
                        <div class="footer-logo w-100">
                            <img src="{{ asset(get_option('general')['login_page_logo'] ?? 'assets/images/icons/logo.svg') }}" alt="logo">
                        </div>
                        ...
                        <form method="POST" action="{{ route('password.code.email') }}">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" name="email" class="form-control w-100 dynamictext" value="{{ old('email') }}" placeholder="{{ __('Enter your Email') }}">
                            </div>
                ...
                <div class="login-img">
                    <img src="{{ asset(get_option('general')['login_page_img'] ?? 'assets/images/login/login-avatar.png') }}" alt="">
                </div>
            </div>
        </div>
    </div>

...
function showInputErrors(e) {
  if (!e || typeof e.errors === "undefined") return;
...
if (
  (!(function (e) {
    ...
    (e.fn.initValidate = function () {
      ...
      e("#is_period").on("change", function () {
        1 == e(this).val()
          ? e(".period_duration").removeClass("d-none")
          : e(".period_duration").addClass("d-none");
      }),
      ...
      (e.fn.initFormValidation = function () {
        var t = e(this).validate({
          ...
          errorPlacement: function (t, s) {
            var a = e(s);
            a.hasClass("select2-hidden-accessible")
              ? ((s = e("#select2-" + a.attr("id") + "-container").parent()),
                t.insertAfter(s))
              : a.parents().hasClass("image-checkbox") ||
                (a.parent().hasClass("form-floating")
                  ? t.insertAfter(s.parent().css("color", "text-danger"))
                  : a.parent().hasClass("input-group")
                  ? t.insertAfter(s.parent())
                  : t.insertAfter(s));
          },
        });
    ...
    "undefined" != typeof jQuery &&
      void 0 !== e.fn.select2 &&
      ([].slice
        .call(document.querySelectorAll('[data-control="select2"]'))
        .map(function (t) {
          var s = { dir: document.body.getAttribute("direction") };
          "true" == t.getAttribute("data-hide-search") &&
            (s.minimumResultsForSearch = 1 / 0),
            t.hasAttribute("data-placeholder") &&
              (s.placeholder = t.getAttribute("data-placeholder")),
  ...
  $(document).ready(function () {
    "true" === window.sessionStorage.hasPreviousMessage &&
      (Notify(
        "success",
        null,
      ...
      (window.sessionStorage.hasPreviousMessage = !1));
  }),
  $("#selectAll").length > 0)
) {
